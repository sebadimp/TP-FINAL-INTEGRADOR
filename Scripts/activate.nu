...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Seba\Desktop\Codo a Codo\Fullstack Python\Back End\crud\proyecto'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Seba\Desktop\Codo a Codo\Fullstack Python\Back End\crud\proyecto\Scripts\deactivate.nu'
